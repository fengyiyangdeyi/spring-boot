...
public class SysLogAspect {
     ...
     * 切点表达式:   execution(...)
     */
    @Pointcut("@annotation(com.lyf.aop.anno.SysLog)")
    public void logPointCut() {
    }

    @Before("logPointCut()")
    public void around() {
        System.out.println("我在最前执行！");
    }

    /**
     * 环绕point.proceed通知 @Around  ， 当然也可以使用 @Before (前置通知)  @After (后置通知)
     *
     * @param point
     * @return
     * @throws Throwable
